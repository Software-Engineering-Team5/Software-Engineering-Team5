...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QRect(0, 140, 1001, 71))
        ...
        self.verticalLayoutWidget_8.setGeometry(QRect(320, 220, 61, 31))
        ...
        self.verticalLayoutWidget_9.setGeometry(QRect(620, 220, 61, 70))
        ...
        self.verticalLayoutWidget_10.setGeometry(QRect(320, 260, 61, 31))
        ...
        self.verticalLayoutWidget_4.setGeometry(QRect(320, 310, 351, 41))
        ...
        self.verticalLayoutWidget_5.setGeometry(QRect(320, 350, 351, 41))
        ...
        self.signUpButton.setGeometry(QRect(109, 0, 131, 41))

        self.verticalLayout_6.addWidget(self.frame_4)

        self.password = QLineEdit(self.centralwidget)
        self.password.setObjectName(u"password")
        self.password.setGeometry(QRect(380, 260, 241, 31))
        self.password.setMaxLength(100)
        self.password.setEchoMode(QLineEdit.Password)
        self.id = QLineEdit(self.centralwidget)
        self.id.setObjectName(u"id")
        self.id.setGeometry(QRect(380, 220, 241, 31))
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label.setText(QCoreApplication.translate("LoginWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:700;\">\ub85c\uadf8\uc778</span></p></body></html>", None))
